...
1. 【身分與渠道檢驗】：發送者是否冒充金融機構、公務機關、知名電商或親友？發送渠道（如非官方短網址、奇怪國碼電話）是否存在偽冒跡象？
2. 【利益誘餌與損失威脅】：訊息中是否提供異常高報酬（保證獲利、免費領獎）、或者利用損失恐懼（即將扣款、帳戶凍結、違法通緝）施壓？
3. 【心理操控技術分析】：是否運用了「製造急迫感（限時領取/扣款）」、「權威服從」、「貪婪誘餌」或「社交孤立（要求不可告訴家人/要求私加 Line）」？
4. 【要求之具體行動】：是否涉及「要求操作 ATM/網銀」、「點擊可疑連結輸入帳密/OTP 驗證碼」、「匯款至私人帳戶」或「下載非官方 APK/App」？
5. 【防誤判機制 (Guardrail)】：若訊息僅為合法的交易通知（如銀行刷卡無異常短網址、物流取件通知），且無任何轉帳要求與急迫威脅，應客觀判定為安全，切勿過度反應。"""

# L3: 8 大常見詐騙特徵指南 (In-Context Taxonomy)
SCAM_TACTICS_TAXONOMY = """### 常見詐騙手法特徵指南：
- 假投資飆股：強調「穩賺不賠」、「內線消息」、「老師帶盤」、「高頻交易」，誘導加入私密 Line 投資群或下載非官方交易平台。
- 假解除分期付款：聲稱「工作人員疏失設為批發商/連續扣款」，要求「至 ATM 或使用網銀進行身分驗證/解除設定」。
- 假檢警公文：聲稱「涉及洗錢/重大刑案」、「偵查不公開不可告訴他人」，發送偽造公文並要求「將資金匯至監管帳戶」或面交保證金。
- 釣魚簡訊/惡意短網址：偽冒「監理站罰款」、「水電費逾期」、「健保卡停卡」、「中獎通知」，附帶非 .gov.tw 結尾之短網址騙取信用卡號或 OTP。
- 假交友殺豬盤：先建立曖昧感情信任，隨後藉口「有賺錢項目」、「家中急需用錢」、「幫忙代操加密貨幣」誘導匯款。
- 假求職兼職：強調「在家工作、日領千元、免經驗」，實為騙取帳戶作為人頭帳戶，或要求先繳交材料保證金。"""
